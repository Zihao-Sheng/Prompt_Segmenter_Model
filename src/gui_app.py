...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        _yolo11_row_layout = QtWidgets.QHBoxLayout(self._yolo11_model_row)
        _yolo11_row_layout.setContentsMargins(0, 0, 0, 0)
        _yolo11_row_layout.addWidget(self.yolo11_model_edit)
        _yolo11_row_layout.addWidget(self._yolo11_model_browse)
